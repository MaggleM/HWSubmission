...
<script type="text/template" id="edit-tpl" >
    <tr>
       ...
       <td><input type="text" name="Callories_Burned" class="form-control" placeholder="Callories Burned" value="{{Callories_Burned}}" /></td>
       <td><input type="text" name="Num_Reps" class="form-control" placeholder="Number of Reps" value="{{Num_Reps}}" /></td>
       <td>
